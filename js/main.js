...
window.setTimeout(()=>{
  ...
  /////////////////////////////////////////////
    $(window).scroll(function(){
      if($(window).scrollTop() > $(this).innerHeight()*2)
      {
        $("#up").css("display", "flex")  
  ...
  ////////////////////////////////////////////
    ...
    ////////////////////////////////////////////// start close animation function //////////////////////////////
      $("#closeIcon").click(()=> {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /////////////////////////////////////// start fetch api  using xmlhttprequest /////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    let movies = [];
    ...
    getApi(now_playing); // set now_playing a default page
    ///////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////// display function ////////////////////////////////
    ...
    ///////////////////////////////////////// display side bar categories on click  ////////////////////////////////
    ...
    async function searchByWord() {
      if(movieWord.value == ""){getApi(now_playing)} // herg3ny now playing page
      else{ 
        let eVentTarget = this; // 34an lw 3mlt this hebqa f func inside func w this = window
        ...
        then(function(response) {
          if (!response.ok && response.status != 200) {
            ...
            // lo f error f el code y3mlh print 
          }
            return response; // 34an a3rf at3amel m4 el response tani
        }).
    ...
    ////////////////////// kont momken a3mlha b XMlHttpRequest bs tmren 3l fetch w async w await //////////////////////
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
